...
class VGG(nn.Module):
    def __init__(self, num_classes, depth=16, batch_norm=False, fix_points=None):
...
def vgg16(num_classes=10, fix_points=None):
    return VGG(num_classes=num_classes, depth=16, fix_points=fix_points)
