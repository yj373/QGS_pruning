...
class _DenseLayer(nn.Module):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, fix_points=None):
        ...
        # self.add_module('norm_1', BatchNorm2d(num_input_features, **kwargs)),
        # self.add_module('relu_1', nn.ReLU(inplace=True)),
        # self.add_module('conv_1', Conv2d(num_input_features, bn_size *
        #                 growth_rate, kernel_size=1, stride=1, bias=False, **kwargs)),
        # self.add_module('norm_2', BatchNorm2d(bn_size * growth_rate, **kwargs)),
        # self.add_module('relu_2', nn.ReLU(inplace=True)),
        # self.add_module('conv_2', Conv2d(bn_size * growth_rate, growth_rate,
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate, fix_points=None):
    ...
    def forward(self, x, *args):
        ...
        #     new_features = layer(features, *args)
...
class _Transition(nn.Module):
    def __init__(self, num_input_features, num_output_features, fix_points=None):
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 ...
                 small_inputs=True, init_method='kaiming', fix_points=None):
...
def densenet100(num_classes=10, init_method='kaiming',fix_points=None):
    return DenseNet(growth_rate=12, block_config=(16, 16, 16),
                 num_init_features=24, bn_size=4, drop_rate=0,
                 num_classes=num_classes, small_inputs=True, init_method=init_method, fix_points=fix_points)
