...
import models.curves_tt as curves
...
class BasicBlockCurve(nn.Module):
    ...
    def __init__(self, inplanes, planes, fix_points=None, stride=1, downsample=None):
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, depth=110, fix_points=None, n=-1):
...
def resnet20(num_classes=10, fix_points=None):
    return ResNet(num_classes=num_classes, depth=20, fix_points=fix_points)

def resnet56(num_classes=10, fix_points=None, n=9):
    return ResNet(num_classes=num_classes, depth=56, fix_points=fix_points, n=9)

def resnet110(num_classes=10, fix_points=None):
    return ResNet(num_classes=num_classes, depth=110, fix_points=fix_points)

def resnet164(num_classes=10, fix_points=None):
    return ResNet(num_classes=num_classes, depth=164, fix_points=fix_points)
